...
\newitem{Data scientist -- Experimentation and causal inference}{Just Eat Takeaway}{}{Nov 2022--present}
\desc{As part of the company's central data science team focused on experimentation and causal inference, I}
\tasks{develop and deploy advanced experimentation methods at scale}
[develop and disseminate best practices for experimentation and causal inference]
...
\desc{PhD enrichment student at the Alan Turing Institute, the UK’s national institute for
data science and AI, 2022--2023}\\
\desc{Warwick Business School scholarship, full funding for PhD studies, 2019--2023}\\
\desc{Berrow scholarship, full funding for MPhil studies at the University of Oxford,
2015--2017}\\
\desc{Faculty prize for graduating with highest honours (top 5 \%) in MSc in Economics,
University of Bern, 2014}\\
\desc{Participant of the 11. Carroll Round, a selective undergraduate conference at
